...
def step_impl(context, jisu1, jisu2, phengim_with_space):
    ...
    RimeApiConfig.prepare_user_dict_file_for_bdd(dict_word_lines)

    context.phengim_with_space = phengim_with_space
    found_word1 = RimeApiConfig.user_dict_contains_word(jisu1, phengim_with_space)
    found_word2 = RimeApiConfig.user_dict_contains_word(jisu2, phengim_with_space)
